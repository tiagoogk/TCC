...
# $Id: install.sh.in 541872 2017-07-23 14:21:00Z ucko $
...
old_srcdir='/home/tiagotcc/tcc/programas/ncbi-blast-2.11.0+-src/c++'
...
(cd $script_dir  &&  for f in Makefile.* *.sh *.py *.cfg; do
   case $f in
